...
def __get_colliders(game_character, colliders_group):
    ...
    # if game_objects.Tag.player is game_character.tag:
    #     temp = []
    #     for thing in colliders_group:
    #         if thing.tag is game_objects.Tag.grass:
    #             temp.append(thing)
    #             colliders_group.remove(thing)

...
def get_movement_inputs(pressed_keys):
    ...
    direction_x, direction_y = 0.0, 0.0 #, attacks = 0.0, 0.0, 0.0
    ...
    # if is_pressed(pressed_keys, attack):
    #     attacks = 1.0

    return direction_x, direction_y#, attacks
...
def get_inputs():
    ...
    direction_x, direction_y = get_movement_inputs(pressed_keys) #, attacks = get_movement_inputs(pressed_keys)

    return direction_x, direction_y, is_game_over#, attacks
